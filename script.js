...
document.getElementById('start-show-button').addEventListener('click', function() {
  ...
  if (leftCurtain && rightCurtain) {
    ...
    leftCurtain.addEventListener('transitionend', function() {
      ...
      document.documentElement.style.cursor = 'url("https://jsalexan.github.io/muppafones/images/Muppa-mallet.png"), auto';
      document.body.style.cursor = 'url("https://jsalexan.github.io/muppafones/images/Muppa-mallet.png"), auto';
    });
